...
contextBridge.exposeInMainWorld('cue', {
  ...
  on: (channel, cb) => {
    const allowed = ['capture:state', 'llm:start', 'llm:token', 'llm:done', 'llm:error', 'status', 'transcript', 'stt:interim', 'stt:final', 'stt:status', 'vad:state', 'applink:consent-request', 'hide:toggle', 'drag:hover', 'whisper:download-progress', 'whisper:models-changed'];
